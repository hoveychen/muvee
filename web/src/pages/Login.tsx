...
function ProviderIcon({ id }: { id: string }) {
  switch (id) {
    ...
    case 'feishu':
      return (
        <svg width="18" height="18" viewBox="3 3 43 43">
          <path d="M10 7h17.2c3.3 2.8 5.6 6.8 7 10.3c-2.9.9-5.3 2.8-7.4 5.2l-1.6 1.9C21.600 16.800 15.500 11.200 10 7z" fill="#00D6B9"/>
          <path d="M20.500 30.800c2.600-1.300 4.800-3.300 6.900-5.700l1.600-1.900C35.500 15.600 41 16.300 45 18.600c-2.800 1.600-4.300 4.500-5.400 7.600c-1.400 4-3 7.200-6.300 10c-4 3.200-8.600 1.100-12.800-5.400z" fill="#133C9A"/>
          <path d="M4 15.500c4.200 6.200 10.600 12.300 16.500 15.300c5.200 2.700 9.400 3.600 12.800 5.400C29 40 24 41.500 19 41.500c-6 0-11.300-2.800-15-5.600z" fill="#3370FF"/>
        </svg>
      )
    case 'wecom':
      return (
