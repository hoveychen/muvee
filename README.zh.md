...
| Provider | 需配置的环境变量 |
|---|---|
| [Google](https://hoveychen.github.io/muvee/zh/docs/auth/google) | `GOOGLE_CLIENT_ID`、`GOOGLE_CLIENT_SECRET` |
| [飞书 / Lark](https://hoveychen.github.io/muvee/zh/docs/auth/feishu) | `FEISHU_APP_ID`、`FEISHU_APP_SECRET` |
| [企业微信](https://hoveychen.github.io/muvee/zh/docs/auth/wecom) | `WECOM_CORP_ID`、`WECOM_CORP_SECRET`、`WECOM_AGENT_ID` |
| [钉钉](https://hoveychen.github.io/muvee/zh/docs/auth/dingtalk) | `DINGTALK_CLIENT_ID`、`DINGTALK_CLIENT_SECRET` |
...
| 身份认证 Provider | 至少一个：[Google](https://hoveychen.github.io/muvee/zh/docs/auth/google)、[飞书/Lark](https://hoveychen.github.io/muvee/zh/docs/auth/feishu)、[企业微信](https://hoveychen.github.io/muvee/zh/docs/auth/wecom)、[钉钉](https://hoveychen.github.io/muvee/zh/docs/auth/dingtalk) |
...
- **身份认证** — [Google](https://hoveychen.github.io/muvee/zh/docs/auth/google) · [飞书/Lark](https://hoveychen.github.io/muvee/zh/docs/auth/feishu) · [企业微信](https://hoveychen.github.io/muvee/zh/docs/auth/wecom) · [钉钉](https://hoveychen.github.io/muvee/zh/docs/auth/dingtalk)
